...
public class BandejaTest {
    ...
    void filtro_por_contenido(){
		...
		String filtradoporContenido = "Subir notas, Por favor";
       
		ArrayList<Email> emailsfiltrados = b1.filtros(em1.getBandejaEntrada(persona2), b1.filtroContenido(filtradoporContenido));
...
//asunto+remitente
	...
	Contacto remitenteAfiltrar = persona1;
    String asuntoparaFiltrar = "Trabajo";
   
	ArrayList<Email> emailsfiltrados = b1.filtros(em1.getBandejaEntrada(persona2), b1.filtroPorcorreoYasunto(remitenteAfiltrar, asuntoparaFiltrar));
